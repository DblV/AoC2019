...
let WiringPathIntersectionDistanceCalculatedCorrectly wirePath1 wirePath2 expectedDistance =
    Assert.AreEqual(expectedDistance, calculateNearestIntersection ([wirePath1;wirePath2] |> List.toSeq))
