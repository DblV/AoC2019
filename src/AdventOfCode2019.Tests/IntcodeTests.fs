...
let Opcode4OutputCorrect () =
    compareResultingListAndOutput [4;0;99] 5 (runIntcodeComputerFromStringInputWithInitialInput "4,0,99" 5)
    compareResultingListAndOutput [4;3;99;1] 10 (runIntcodeComputerFromStringInputWithInitialInput "4,3,99,1" 10)
    compareResultingListAndOutput [104;2;99] 3 (runIntcodeComputerFromStringInputWithInitialInput "104,2,99" 3)
...
let MultipleOpcodeInputOutputsCorrect () =
    ...
    compareResultingListAndOutput [11102;-1;-100;100;4;3;99] 1 (runIntcodeComputerFromStringInputWithInitialInput "11102,-1,-100,3,4,3,99" 1)
    compareResultingListAndOutput [1105;1;5;0;0;1;0;1;1106;4;8;99] -1 (runIntcodeComputerFromStringInputWithInitialInput "1105,1,5,0,0,1,0,1,8,4,8,99" -1)
    ...
    compareResultingListAndOutput [3;9;8;9;10;9;4;9;99;1;8] 8 (runIntcodeComputerFromStringInputWithInitialInput "3,9,8,9,10,9,4,9,99,-1,8" 8)
    compareResultingListAndOutput [3;9;7;9;10;9;4;9;99;0;8] 8 (runIntcodeComputerFromStringInputWithInitialInput "3,9,7,9,10,9,4,9,99,-1,8" 8)
    compareResultingListAndOutput [3;3;1108;0;8;3;4;3;99] 10 (runIntcodeComputerFromStringInputWithInitialInput "3,3,1108,-1,8,3,4,3,99" 10)
    compareResultingListAndOutput [3;3;1107;1;8;3;4;3;99] 5 (runIntcodeComputerFromStringInputWithInitialInput "3,3,1107,-1,8,3,4,3,99" 5)
